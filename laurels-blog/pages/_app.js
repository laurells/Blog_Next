    ...
    return (
      <Html lang="en" className="scroll-smooth">
        <Head>
          ...
          <meta
            name="description"
            content="Welcome to my personal blog where I share my experiences and thoughts. I am a Software Engineer passionate about Softwares and web development technologies."
          />
